...
<div className="m-4 text-dark d-flex justify-content-around"><h1>Private Transfers</h1></div>
    <div className="m-5 text-dark d-flex justify-content-between"><h2>What is a Luxury Concierge? </h2></div>
